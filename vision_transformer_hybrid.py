...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=[512], patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
        ...
        patch_size = (img_size[0] // 32 // 16, img_size[0] // 32 // 16)
        num_patches = (img_size[0] // 32 // patch_size[0]) * (img_size[0] // 32 // patch_size[1])
        ...
        ckpt = torch.load('./jf_utils/pretrained/jf_best.ckpt')
