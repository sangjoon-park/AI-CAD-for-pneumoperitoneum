...
def train_dino(args):
    ...
    dataset = Abdomen_dataset.CXR_Dataset(args.view, args.data_train, size=1.0, transforms=transform, mode='train', labeled=True)
    ...
    if args.arch in vit_o.__dict__.keys():
        if args.pretrained:
            ...
            student = torch.hub.load('facebookresearch/dino:main', 'dino_vits8')
            teacher = torch.hub.load('facebookresearch/dino:main', 'dino_vits8')
            print('ImageNet weights will be used.')
            embed_dim = student.embed_dim
    ...
    # otherwise, we check if the architecture is in torchvision models
        ...
        teacher = torchvision_models.__dict__[args.arch](pretrained=True)
        ...
        if args.pretrained:
            ...
            print('ImageNet pretrained weights will be used.')
    else:
...
if __name__ == '__main__':
    parser = main_dino.get_args_parser()    # Integrated code
